...
from victim.cifar100_models.densenet import densenet121, densenet161, densenet169
from victim.cifar100_models.googlenet import googlenet
from victim.cifar100_models.mobilenetv2 import mobilenet_v2
from victim.cifar100_models.resnet import resnet18, resnet34, resnet50
from victim.cifar100_models.vgg import vgg11_bn, vgg13_bn, vgg16_bn, vgg19_bn
...
class CIFAR100Module(pl.LightningModule):
    def __init__(self, params, train_size):
        ...
        self.transforms = transforms.Normalize((0.5071, 0.4867, 0.4408),(0.2675, 0.2565, 0.2761))
